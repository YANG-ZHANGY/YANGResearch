* Encoding: Big5.
DATA LIST FILE="E:\PP2397C1\PP2397C1.dat" /
...
Q24 "今年11月在美國舉辦的拜習會中，習近平明確表示北京方面希望和平統一，但是不放棄使用武力。對此拜登回應，美國的長期立場是維持兩岸和平穩定。請問您認為拜習會對兩岸關係的發展是有好的影響、不好的影響，還是沒有影響?"
Q25 "關於臺灣和大陸的關係，有下面幾種不同的看法: 1.儘快統一2.儘快宣佈獨立3.維持現狀，以後走向統一4.維持現狀，以後走向獨立5.維持現狀，看情形再決定獨立或統一6.永遠維持現狀。請問您比較偏向哪一種?"
...
/Q5
     ...
     45 "長照問題"    50 "人口問題"    53 "環保問題"   54 "言論自由"    56 "兵役制度"
     59 "公共衛生"    60 "安樂死立法"
